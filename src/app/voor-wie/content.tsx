...
export default function VoorWiePage() {
  ...
  return (
    <div className="py-32 max-md:py-24 px-6 max-md:px-4 max-w-4xl mx-auto">
      <Reveal>
        <h2 className="text-4xl max-md:text-3xl font-serif mb-12 max-md:mb-8 text-[#333D3B]">Voor wie</h2>
      </Reveal>
      ...
      <Reveal delay={0.2} width="100%">
        <section className="bg-white border border-[#A5A58D]/30 p-10 max-md:p-6 shadow-sm relative overflow-hidden group">
